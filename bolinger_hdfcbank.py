...
Original file is located at
    https://colab.research.google.com/drive/1Bk18m0t2F27Cu7KxDBGKLARhorTepBBr
"""
...
plt.title('Bollinger Band for TCS')
...
ax.set_title('Bollinger Band For TCS')
ax.set_xlabel('Date')
ax.set_ylabel('INR Price ')
